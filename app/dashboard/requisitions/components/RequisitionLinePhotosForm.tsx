  ...
  const skeleton = (
    <div className="animate-pulse">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
        <div className="h-28 bg-gray-300 rounded w-full mb-2"></div>
        <div className="h-28 bg-gray-300 rounded w-full mb-2"></div>
        <div className="h-28 bg-gray-300 rounded w-full mb-2"></div>
        <div className="h-28 bg-gray-300 rounded w-full mb-2"></div>
      </div>
          ...
          {photos.length > 0 ? (
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
              {photos.map((photo) => (
                <div
                  key={photo.id}
                  onClick={() => setSelectedPhoto(`${photo.image_path}`)}
...
group-hover:opacity-100 flex items-center justify-center transition duration-300 rounded-2xl"
                  >
